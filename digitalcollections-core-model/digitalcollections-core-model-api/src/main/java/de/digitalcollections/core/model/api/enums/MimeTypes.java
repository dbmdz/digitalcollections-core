...
public class MimeTypes {
  ...
  static {
    ...
    MIMETYPE_MAPPING = new LinkedHashMap<String, String>(200) {
...

      {
        ...
        put1("dll", MIME_APPLICATION_X_MSDOS_PROGRAM);
        ...
        put1("exe", MIME_APPLICATION_X_MSDOS_PROGRAM);
  ...
  public static String getExtension(MimeType mimeType) {
    return getExtension(mimeType.toString());
  }
  ...
  public static MimeType getMimeType(String ext) {
    String mimeTypeStr = lookupMimeType(ext);
    if (mimeTypeStr == null) {
   ...
   * @return MimeType of resource detected by filename extension
   */
